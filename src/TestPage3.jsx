    ...
    <div style={{ height: '100vh', position: 'relative' }}>
      ...
      >
        ...
        <Physics gravity={[0, 0, 0]}>
          <DraggableText position={[-2, 6, -10]} rotation={[-0.3, -0.2, 0]}>Hello my name</DraggableText>
          <DraggableText position={[2, 4, -10]} rotation={[0.3, 0.2, 0]} spacing={{ character: 0.7, word: 1 }}>is Jose Castro !</DraggableText>
